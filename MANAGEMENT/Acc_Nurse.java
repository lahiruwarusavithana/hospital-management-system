...
public class Acc_Nurse extends JFrame {
	...
	public Acc_Nurse() {
		...
		JLabel lblNewLabel = new JLabel("Nurse Accounts");
		...
		JLabel lblNewLabel_2 = new JLabel("Nurse Name");
