...
public class Orthopedic extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Orthopedic frame = new Orthopedic();
	...
	public Orthopedic() {
		...
		JLabel lblNewLabel = new JLabel("ORTHOPEDIC");
		lblNewLabel.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		lblNewLabel.setBounds(416, 10, 296, 102);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type = 'op'";
		...
		btnNewButton_2.setBounds(501, 110, 106, 32);
