...
public class Gyn_obs extends JFrame {
	...
	public Gyn_obs() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				G_admission ad = new G_admission();
				ad.setVisible(true);
		...
		JLabel lblNewLabel_1 = new JLabel("GYN & OBS");
		lblNewLabel_1.setFont(new Font("Perpetua Titling MT", Font.BOLD, 40));
		lblNewLabel_1.setBounds(401, 22, 293, 103);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("05");
		lblNewLabel_2.setFont(new Font("Perpetua Titling MT", Font.BOLD, 33));
		lblNewLabel_2.setBounds(508, 117, 67, 59);
		...
		lblNewLabel_7.setBounds(668, 350, 143, 25);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM ward WHERE w_no = 5;";
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String updateQuery = "UPDATE ward SET available_beds = '"+av.getText()+"', no_of_patients = '"+np.getText()+"' WHERE w_no = 5;";
		...
		lblNewLabel.setBounds(0, -26, 1091, 702);
