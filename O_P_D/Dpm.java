...
public class Dpm extends JFrame {
	...
	public Dpm() {
		...
		JLabel lblNewLabel = new JLabel("DPM");
		lblNewLabel.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		lblNewLabel.setBounds(499, 20, 120, 79);
		contentPane.add(lblNewLabel);
		
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(51, 149, 989, 402);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type = 'dm'";
		...
		btnNewButton_2.setBounds(492, 96, 106, 32);
		contentPane.add(btnNewButton_2);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("Images\\allfor.jpg"));
		lblNewLabel_1.setBounds(0, 0, 1117, 665);
