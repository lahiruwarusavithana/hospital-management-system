...
public class Psychiatric extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Psychiatric frame = new Psychiatric();
	...
	public Psychiatric() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Ps_admission ad = new Ps_admission();
				ad.setVisible(true);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Psychiatric_Profile pf = new Psychiatric_Profile();
				pf.setVisible(true);
		...
		JLabel lblNewLabel_1 = new JLabel("PSYCHIATRIC");
		lblNewLabel_1.setFont(new Font("Perpetua Titling MT", Font.BOLD, 40));
		lblNewLabel_1.setBounds(394, 10, 318, 103);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("04");
		...
		lblNewLabel_6.setBounds(668, 283, 143, 29);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM ward WHERE w_no = 4;";
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String updateQuery = "UPDATE ward SET available_beds = '"+av.getText()+"', no_of_patients = '"+np.getText()+"' WHERE w_no = 4;";
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\user\\Desktop\\zzzzzzz.jpg"));
		lblNewLabel.setBounds(0, -13, 1091, 715);
