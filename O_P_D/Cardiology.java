...
public class Cardiology extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cardiology frame = new Cardiology();
	...
	public Cardiology() {
		...
		JLabel lblNewLabel = new JLabel("CARDIOLOGY");
		lblNewLabel.setBounds(423, 10, 298, 102);
		...
		btnNewButton_2.setBounds(510, 110, 106, 32);
		btnNewButton_2.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type ='cd'";
