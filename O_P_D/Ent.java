...
public class Ent extends JFrame {
	...
	public Ent() {
		...
		JLabel lblNewLabel = new JLabel("ENT");
		lblNewLabel.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		lblNewLabel.setBounds(499, 0, 93, 89);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type = 'et'";
		...
		btnNewButton_2.setBounds(499, 99, 106, 32);
