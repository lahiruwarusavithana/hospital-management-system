...
public class Corona_Profile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Corona_Profile frame = new Corona_Profile();
	...
	public Corona_Profile() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try { 
					...
					String findDetails = "SELECT name,sex,nic,mobile_no,address,weight, entry_date,age,diagnosis_details,trustee FROM corona WHERE p_id = '"+pid.getText()+"';";
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			try {
					...
					String updateQuery = "UPDATE corona SET age = '"+age.getText()+"', address = '"+add.getText()+"', mobile_no = '"+mobi.getText()+"',diagnosis_details = '"+diagnosis.getText()+"' WHERE p_id = '"+pid.getText()+"';";
		...
		JLabel lblMedicine = new JLabel("CORONA");
