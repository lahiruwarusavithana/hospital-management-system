...
public class P_admission extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					P_admission frame = new P_admission();
	...
	try {
					...
					String query = "INSERT INTO pediatric (p_id, name,age,entry_date,bed_no,nic,trustee,mobile_no,address,diagnosis_details,weight,sex) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		JLabel lblNewLabel_12 = new JLabel("PEDIATRIC");
		lblNewLabel_12.setFont(new Font("Sylfaen", Font.PLAIN, 18));
		lblNewLabel_12.setBounds(500, 84, 118, 31);
