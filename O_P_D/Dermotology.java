...
public class Dermotology extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Dermotology frame = new Dermotology();
	...
	public Dermotology() {
		...
		JLabel lblNewLabel = new JLabel("DERMOTOLOGY");
		lblNewLabel.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		lblNewLabel.setBounds(379, 10, 377, 101);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type = 'dt'";
		...
		btnNewButton_2.setBounds(489, 104,127, 32);
