...
public class Surgery_Profile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Surgery_Profile frame = new Surgery_Profile();
	...
	public Surgery_Profile() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try { 
					...
					String findDetails = "SELECT name,sex,nic,mobile_no,address,weight, entry_date,age,diagnosis_details,trustee FROM surgery WHERE p_id = '"+pid.getText()+"';";
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			try {
					...
					String updateQuery = "UPDATE surgery SET age = '"+age.getText()+"', address = '"+add.getText()+"', mobile_no = '"+mobi.getText()+"',diagnosis_details = '"+diagnosis.getText()+"' WHERE p_id = '"+pid.getText()+"';";
		...
		JLabel lblMedicine = new JLabel("SURGERY");
