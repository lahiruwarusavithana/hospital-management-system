...
public class Psycology extends JFrame {
	...
	public Psycology() {
		...
		JLabel lblNewLabel = new JLabel("PSYCOLOGY");
		lblNewLabel.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		lblNewLabel.setBounds(411, -10, 294, 107);
		contentPane.add(lblNewLabel);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(55, 182, 1002, 391);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type = 'pl'";
		...
		btnNewButton_2.setBounds(492, 113,106, 32);
