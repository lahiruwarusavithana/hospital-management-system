...
public class Psychiatric_Profile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Psychiatric_Profile frame = new Psychiatric_Profile();
	...
	public Psychiatric_Profile() {
		...
		lblNewLabel_2.setBounds(73, 376, 107, 38);
		...
		lblNewLabel_4.setBounds(73, 282, 107, 28);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Address");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_5.setBounds(73, 431, 107, 38);
		...
		lblNewLabel_8.setBounds(73, 476, 143, 53);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try { 
					...
					String findDetails = "SELECT name,sex,nic,mobile_no,address,weight, entry_date,age,diagnosis_details,trustee FROM psychiatric WHERE p_id = '"+pid.getText()+"';";
		...
		lblNewLabel_11.setBounds(73, 336, 107, 19);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Psychiatric md = new Psychiatric();
				md.setVisible(true);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			try {
					...
					String updateQuery = "UPDATE psychiatric SET age = '"+age.getText()+"', address = '"+add.getText()+"', mobile_no = '"+mobi.getText()+"',diagnosis_details = '"+diagnosis.getText()+"' WHERE p_id = '"+pid.getText()+"';";
		...
		JLabel lblMedicine = new JLabel("PSYCHIATRIC");
