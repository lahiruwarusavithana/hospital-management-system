...
public class S_admission extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					S_admission frame = new S_admission();
	...
	try {
					...
					String query = "INSERT INTO surgery (p_id, name,age,entry_date,bed_no,nic,trustee,mobile_no,address,diagnosis_details,weight,sex) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		JLabel lblNewLabel_12 = new JLabel("SURGERY");
		lblNewLabel_12.setFont(new Font("Sylfaen", Font.PLAIN, 18));
		lblNewLabel_12.setBounds(517, 84, 85, 31);
