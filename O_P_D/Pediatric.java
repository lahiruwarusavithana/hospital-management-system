...
public class Pediatric extends JFrame {
	...
	public Pediatric() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				P_admission ad = new P_admission();
				ad.setVisible(true);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Pediatric_Profile pf = new Pediatric_Profile();
				pf.setVisible(true);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM ward WHERE w_no = 2;";
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String updateQuery = "UPDATE ward SET available_beds = '"+av.getText()+"', no_of_patients = '"+np.getText()+"' WHERE w_no = 2;";
		...
		lblNewLabel.setBounds(0, -42, 1104, 765);
