...
public class G_admission extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					G_admission frame = new G_admission();
	...
	public G_admission() {
		...
		lblNewLabel.setBounds(457, 0, 280, 81);
	...
	try {
					...
					String query = "INSERT INTO go (p_id, name,age,entry_date,bed_no,nic,trustee,mobile_no,address,diagnosis_details,weight) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
		...
		btnNewButton.setBounds(911, 635, 85, 21);
		...
		JLabel lblNewLabel_12 = new JLabel("GYN & OBS");
		lblNewLabel_12.setFont(new Font("Sylfaen", Font.PLAIN, 18));
		lblNewLabel_12.setBounds(506, 86, 151, 31);
