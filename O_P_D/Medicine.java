	...
	public Medicine() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				M_admission ad = new M_admission();
				ad.setVisible(true);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Medicine_Profile pf = new Medicine_Profile();
				pf.setVisible(true);
		...
		JLabel lblNewLabel_2 = new JLabel("01");
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM ward WHERE w_no = 1;";
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String updateQuery = "UPDATE ward SET available_beds = '"+av.getText()+"', no_of_patients = '"+np.getText()+"' WHERE w_no = 1;";
		...
		lblNewLabel.setBounds(0, -54, 1146, 792);
