...
public class C_admission extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					C_admission frame = new C_admission();
	...
	try {
					...
					String query = "INSERT INTO corona (p_id, name,age,entry_date,bed_no,nic,trustee,mobile_no,address,diagnosis_details,weight,sex) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		JLabel lblNewLabel_12 = new JLabel("CORONA");
