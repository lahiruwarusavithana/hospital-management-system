...
public class Skin extends JFrame {
	...
	public Skin() {
		...
		JLabel lblNewLabel = new JLabel("SKIN");
		lblNewLabel.setFont(new Font("Lucida Sans", Font.BOLD, 40));
		lblNewLabel.setBounds(479, 10, 129, 80);
		contentPane.add(lblNewLabel);
		
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(45, 165, 1002, 325);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "SELECT * FROM clinical_patient WHERE clinic_type = 'sk'";
		...
		btnNewButton_2.setBounds(479, 118, 113, 32);
