...
public class Nurse extends JFrame {
	...
	public Nurse() {
		...
		btnNewButton.setBounds(842, 555, 89, 23);
		...
		btnNewButton_1.setBounds(121, 555, 89, 23);
		contentPane.add(btnNewButton_1);
		btnNewButton_1.setFont(new Font("Tahoma", Font.BOLD, 16));
		
		lblNurse = new JLabel("Nurse");
		lblNurse.setBounds(465, 29, 151, 34);
		contentPane.add(lblNurse);
		lblNurse.setFont(new Font("Times New Roman", Font.BOLD, 40));
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(121, 94, 810, 435);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "SELECT e_id,name,position,sex,e_mail FROM staff WHERE e_id LIKE 'N%' ";
		...
		btnNewButton_2.setBounds(506, 556, 85, 21);
		contentPane.add(btnNewButton_2);
		
		lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("Images\\allfor.jpg"));
		lblNewLabel.setBounds(0, 0, 1108, 659);
